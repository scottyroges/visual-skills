...
describe("renderTldr", () => {
  it("renders the TL;DR card with facets and a level-coded risk chip (NO points)", async () => {
    ...
    expect(html).not.toContain("tldr-start"); // the "Start here" link was removed
  });
  it("omits facets/risk gracefully when absent", async () => {
